...
//            String query = "select locate('de', 'abcdegf') from Member m";
            ...
            //////// 오류 - t.members.size를 해도 원하는 결과가 나오지 않는다
            // 연관관계 주인 상대편이 사용가능
...
//            String query = "select group_concat(m.username) from Member m";
//
            // substring, size, index, group_concat
...
//======
            ...
            // join은 inner join 이므로 member1,2 와 소속 team1, member3 과 소속 team2를 반환한다.
            Team teamA = new Team();
            teamA.setName("teamA");
            em.persist(teamA);
